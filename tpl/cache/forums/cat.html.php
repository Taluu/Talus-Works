<?php $tpl->includeTpl('head.html', false, 0); ?>
				...
				<table class="list_forums">
					...
					<tbody>
						<?php if ($tpl->getBlock('cat')) : $__tpl_b0843dc53347aa4f84d1723218ab2e5fac5b783d = &$tpl->getBlock('cat'); foreach ($__tpl_b0843dc53347aa4f84d1723218ab2e5fac5b783d as &$__tplBlock['cat']){ ?>
							<tr class="cats">
							...
							<?php if (isset($__tplBlock['cat']['forums'])) : $__tpl_52ba0ff3fc05d1adc40461cd0cca20e1fec76adc = &$__tplBlock['cat']['forums']; foreach ($__tpl_52ba0ff3fc05d1adc40461cd0cca20e1fec76adc as &$__tplBlock['forums']){ ?>
								<tr class="forums">
									<td class="flag_read">
									...
									<td class="forums_name">
										...
										<?php endif; ?>
										<?php if (isset($__tplBlock['forums']['subs'])) : $__tpl_aec60784e9e6390d091a26de47d695ccdc4e2147 = &$__tplBlock['forums']['subs']; foreach ($__tpl_aec60784e9e6390d091a26de47d695ccdc4e2147 as &$__tplBlock['subs']){ ?>
